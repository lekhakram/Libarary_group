...
Feature: As a librarian i should be able to create a new Book
  ...
  Scenario Outline: Libarian login
    When Librarian enters valid "<email>" and "<password>" and click sign in
    And Librarian clicks Books module
    And Librarian click “+ Add Book" button
    And Librarian enter bookName , ISBN , Year, Author and Description
